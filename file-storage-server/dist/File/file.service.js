...
let FileService = class FileService {
    filesRepository;
    roomsRepository;
    constructor(filesRepository, roomsRepository) {
        this.filesRepository = filesRepository;
        this.roomsRepository = roomsRepository;
    }
    createUploadPath(user, room) {
    ...
    generateFilename(file) {
        ...
        return `${file.fieldname}-${unique}${(0, path_1.extname)(file.originalname)}`;
    }
    async saveFile(file, dto) {
